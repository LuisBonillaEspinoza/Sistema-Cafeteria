      ...
      <div class="col-md-16">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              session_start();
              $copro = $con->query("select * from producto where produ_codigo_int='". $_GET['id']."'");
              while($row=$copro->fetch_array()){
                  echo $row['produ_nombre_string'];
              }
              ?>" required name="nom">
            ...
            <div class="col-sm-6">
              ...
              $despro = $con->query("select * from producto where produ_codigo_int='". $_GET['id']."'");
              while($row1=$despro->fetch_array()){
                echo $row1['produ_des_string'];
              }
              ?>" required name="des">
              <div class="invalid-feedback">
                Campo Requerido
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                ...
                $exispro = $con->query("select * from producto where produ_codigo_int='". $_GET['id']."'");
                while($row2=$exispro->fetch_array()){
                  echo $row2['produ_existencia_int'];
                }
                ?>">
              <div class="invalid-feedback">
                  Campo Requerido
            ...
            <div class="col-12">
              ...
              $precio = $con->query("select * from producto where produ_codigo_int='". $_GET['id']."'");
              while($row3=$precio->fetch_array()){
                echo $row3['produ_precio_do'];
              }
              ?>">
              <div class="invalid-feedback">
                Campo Requerido
...
if($con==null){
  echo 'error';
    ...
    $pro = $con->query("update producto set produ_nombre_string='".$nom."', produ_des_string='".$des."', produ_existencia_int='".$exis."', produ_precio_do='".$pre."', categoria_codigo_int='".$tipo."' where produ_codigo_int='". $_GET['id']."'");
