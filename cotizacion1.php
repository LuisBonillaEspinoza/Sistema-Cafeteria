			...
			<div class="product-item" category="platos">
				...
				<div class="product-item" category="platos">
					...
					<form action="<?php if(isset($_POST['juane'])){
						...
						echo '';}?>" method="post"><input type="hidden" name="pro" value="14"><input name="pro2" type="number" size="7px" style="text-align: center;" value=""><br><div style="width:100%; height:100%">
...
<input type="submit" name="juane" value="Hacer Pedido"/>
				   </div></form>
				...
				<div class="product-item" category="platos">
					...
					<form action="carrito.php" method="post"><input type="hidden" name="pro" value="1"><input name="pro3" type="number" size="7px" style="text-align: center;" value="0"><br><div style="width:100%; height:100%">
